    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg z-40" role="navigation" aria-label="Mobile navigation">
        <div className="flex justify-around items-center h-14">
          <Link href="/dashboard" className="flex flex-col items-center py-1 px-2 text-gray-600 hover:text-indigo-600 min-w-[60px]" aria-label="Dashboard">
          ...
          <Link href="/patients" className="flex flex-col items-center py-1 px-2 text-gray-600 hover:text-indigo-600 min-w-[60px]" aria-label="Patients">
          ...
          <Link href="/agenda" className="flex flex-col items-center py-1 px-2 text-gray-600 hover:text-indigo-600 min-w-[60px]" aria-label="Agenda">
          ...
          <Link href="/meal-plans" className="flex flex-col items-center py-1 px-2 text-gray-600 hover:text-indigo-600 min-w-[60px]" aria-label="Meal Plans">
          ...
          <Link href="/settings" className="flex flex-col items-center py-1 px-2 text-gray-600 hover:text-indigo-600 min-w-[60px]" aria-label="Settings">
